 ...
 */
public abstract class AbstractUpdatedPropertyCollectionTypeEvent<C, P extends Collection<C>, E, B extends AnnotationBuilderContext> {

	/** The builder. */
	private final transient AnnotationCollectionPropertyDescriptorBuilder<C, P, E, B> builder;
	/** The property. */
	 ...
	 *            The property.
	 */
	protected AbstractUpdatedPropertyCollectionTypeEvent(final AnnotationCollectionPropertyDescriptorBuilder<C, P, E, B> builder,
	 ...
	 */
	public final AnnotationCollectionPropertyDescriptorBuilder<C, P, E, B> getBuilder() {
		return this.builder;
	}
