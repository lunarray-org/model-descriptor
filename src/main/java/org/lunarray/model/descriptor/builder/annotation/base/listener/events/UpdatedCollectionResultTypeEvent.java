 ...
 *            The collection type.
 */
public final class UpdatedCollectionResultTypeEvent<C, R extends Collection<C>, E, B extends AnnotationBuilderContext> {
	 ...
	 *            The operation.
	 */
	public UpdatedCollectionResultTypeEvent(final AnnotationCollectionResultDescriptorBuilder<C, R, E, B> builder,
	 ...
	 */
	public AnnotationCollectionResultDescriptorBuilder<C, R, E, B> getBuilder() {
		return this.builder;
	}
