 ...
 */
public final class UpdatedParameterCollectionTypeEvent<C, P extends Collection<C>, B extends AnnotationBuilderContext>
		extends AbstractUpdatedParameterCollectionTypeEvent<C, P, B> {
	 ...
	 *            The parameter.
	 */
	public UpdatedParameterCollectionTypeEvent(final AnnotationCollectionParameterDescriptorBuilder<C, P, B> builder,
	 ...
	 */
	public AnnotationCollectionParameterDescriptorBuilder<C, P, B> getCollectionBuilder() {
		return this.builder;
	}
}
