 ...
 *            The builder type.
 */
public abstract class AbstractOperationListener<E, B extends AnnotationBuilderContext>
		implements Listener<UpdatedOperationReferenceEvent<E, B>> {

	/** Default constructor. */
	public AbstractOperationListener() {
		// Default constructor.
	}
}
