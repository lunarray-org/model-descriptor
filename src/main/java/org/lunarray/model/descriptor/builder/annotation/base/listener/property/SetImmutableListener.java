 ...
 *            The builder type.
 */
public final class SetImmutableListener<P, E, B extends AnnotationBuilderContext>
		implements Listener<UpdatedPropertyTypeEvent<P, E, B>> {

	/** The logger. */
	private static final Logger LOGGER = LoggerFactory.getLogger(SetImmutableListener.class);

	/** Default constructor. */
	public SetImmutableListener() {
		// Default constructor.
	}
