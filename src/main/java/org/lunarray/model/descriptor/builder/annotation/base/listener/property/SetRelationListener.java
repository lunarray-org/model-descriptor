 ...
 *            The builder type.
 */
public final class SetRelationListener<P, E, B extends AnnotationBuilderContext>
	...
	public void handleEvent(final UpdatedPropertyTypeEvent<P, E, B> event) throws EventException {
		...
		final DescribedEntity<P> entity = (DescribedEntity<P>) builder.getBuilderContext().getEntityResolverStrategy()
				.resolveEntity(property.getType());
		PropertyBuilderUtil.updateRelation(builder, entity, property);
	}
}
