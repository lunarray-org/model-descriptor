...
import org.lunarray.model.descriptor.builder.annotation.util.PropertyBuilderUtil;
 ...
 */
public final class SetCollectionRelationListener<C, P extends Collection<C>, E, B extends AnnotationBuilderContext>
		implements Listener<UpdatedPropertyCollectionTypeEvent<C, P, E, B>> {
	...
	/** {@inheritDoc} */
	@Override
	public void handleEvent(final UpdatedPropertyCollectionTypeEvent<C, P, E, B> event) throws EventException {
		SetCollectionRelationListener.LOGGER.debug("Handling event {}", event);
		Validate.notNull(event, "Event may not be null.");
		final AnnotationCollectionPropertyDescriptorBuilder<C, P, E, B> builder = event.getBuilder();
		...
		PropertyBuilderUtil.updateRelation(builder, collectionEntity, property);
	}
}
