...
/**
 * Describes a result type reference.
 * 
 * @author Pal Hargitai (pal@lunarray.org)
 * @param <R>
 *            The result type.
 */
public final class ResultReference<R>
	 ...
	 */
	public ResultReference(final PresQualResultTypeDescriptor<R> delegate, final ResultDetail resultTypeDetail, final Class<?> qualifier) {
	...
	public String toString() {
		...
		builder.append("PresentationResultReference[\n");
