 ...
 */
public interface OperationDetailBuilder
	 ...
	 * @return The builder.
	 */
	OperationDetailBuilder buttonKey(final String buttonKey);

	/**
	 * Sets a new value for the orderBuilder field.
	 * 
	 * @param orderBuilder
	 *            The new value for the orderBuilder field.
	 * @return The builder.
	 */
	OperationDetailBuilder order(int orderBuilder);
}
