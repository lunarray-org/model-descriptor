...
public final class FieldMatcher
		extends AbstractMatcher<Field> {

	/** Validation message. */
	private static final String FIELD_NULL = "Field may not be null.";
	...
	/** {@inheritDoc} */
	@Override
	public Class<?> extractType(final Field type) {
		Validate.notNull(type, FieldMatcher.FIELD_NULL);
		return type.getType();
	}
	...
	/** {@inheritDoc} */
	@Override
	protected boolean matchConditions(final Field memberType) {
		return true;
	}
}
