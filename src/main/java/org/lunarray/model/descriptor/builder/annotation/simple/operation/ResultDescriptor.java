...
public final class ResultDescriptor<R>
	 ...
	 */
	protected ResultDescriptor(final ResultDescriptorBuilder<R, ?> builder) {
		super(builder);
	}
	...
	public <A> A adapt(final Class<A> adapterType) {
		Validate.notNull(adapterType, ResultDescriptor.ADAPTER_TYPE_NULL);
	...
	public String toString() {
		...
		builder.append("SimpleResultDescriptor[\n");
