...
/**
 * Converter for {@link AtomicBoolean}.
 * 
 * @author Pal Hargitai (pal@lunarray.org)
 */
public final class AtomicBooleanConverter
		extends AbstractDefaultConverter<AtomicBoolean> {
	...
	/** {@inheritDoc} */
	@Override
	protected AtomicBoolean toInstance(final String stringValue) throws ConverterException {
		AtomicBoolean value = null;
		if (!StringUtil.isEmptyString(stringValue)) {
			value = new AtomicBoolean(Boolean.parseBoolean(stringValue));
		}
		return value;
	}
}
