...
/**
 * Converter for {@link Character}.
 * 
 * @author Pal Hargitai (pal@lunarray.org)
 */
public final class CharacterConverter
		extends AbstractDefaultConverter<Character> {
	...
	/** {@inheritDoc} */
	@Override
	protected Character toInstance(final String stringValue) throws ConverterException {
