...
public final class InetAddressConverter
		extends AbstractDefaultConverter<InetAddress> {
	...
	/** {@inheritDoc} */
	@Override
	protected InetAddress toInstance(final String stringValue) throws ConverterException {
		try {
			return InetAddress.getByName(stringValue);
		} catch (final UnknownHostException e) {
			throw new ConverterException(String.format("Could not find host '%s'.", stringValue), e);
		}
	}
}
