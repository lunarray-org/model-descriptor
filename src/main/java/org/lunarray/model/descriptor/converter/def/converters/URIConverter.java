...
public final class URIConverter
		extends AbstractDefaultConverter<URI> {
	...
	/** {@inheritDoc} */
	@Override
	protected URI toInstance(final String stringValue) throws ConverterException {
		try {
			return new URI(stringValue);
		} catch (final URISyntaxException e) {
			throw new ConverterException(String.format("Could not use uri '%s'.", stringValue), e);
		}
	}
}
