...
public final class XMLGregorianCalendarConverter
		extends AbstractDelegatingConverter<XMLGregorianCalendar> {
	...
	/** {@inheritDoc} */
	@Override
	protected XMLGregorianCalendar toInstance(final String stringValue) throws ConverterException {
		return this.datatypeFactory.newXMLGregorianCalendar(stringValue);
	}

	/** {@inheritDoc} */
	@Override
	protected String toString(final XMLGregorianCalendar instance) throws ConverterException {
		return instance.toXMLFormat();
	}
}
