 ...
 */
public final class CompositeDictionary
		extends AbstractCompositeDictionary<EntityDictionary<?, ?>> {
	 ...
	 */
	public CompositeDictionary(final List<EntityDictionary<?, ?>> dictionaries) {
		super(dictionaries);
	}
}
