...
/**
 * Describes a presentation operation.
 * 
 * @author Pal Hargitai (pal@lunarray.org)
 * @param <E>
 *            The entity type.
 */
public interface PresentationOperationDescriptor<E>
		extends OperationDescriptor<E>, Described {
	 ...
	 */
	String getButton(Locale locale);
	...
	/**
	 * Indicates this operation is visible.
	 * 
	 * @return True if and only if this operation visible.
	 */
	boolean isVisible();
}
