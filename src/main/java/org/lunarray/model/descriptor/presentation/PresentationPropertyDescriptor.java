 ...
 *            The entity type.
 */
public interface PresentationPropertyDescriptor<P, E>
		extends PropertyDescriptor<P, E>, Described {
	 ...
	 * 
	 * @return True if and only if this property is the name property for the
	 *         entity.
	 */
	boolean isName();
	 ...
	 * 
	 * @return True if and only if this property visible.
	 */
	boolean isVisible();
}
