...
import org.lunarray.model.descriptor.creational.domain.CreationalEntity14;
import org.lunarray.model.descriptor.creational.domain.CreationalEntityRegistry;
 ...
 * @author Pal Hargitai
 */
public class CreationalRegistryStrategyTest {
	...
	public void init() throws Exception {
		this.resource = new SimpleClazzResource<Object>(CreationalEntity11.class, CreationalEntity12.class, CreationalEntity13.class,
				CreationalEntity14.class);
		this.model = SimpleBuilder.createBuilder().extensions(new CreationalEntityRegistry()).resources(this.resource).build();
	}
	...
	public void testConstructorCreation() throws Exception {
		...
		Assert.assertEquals(0, entity.creationalStrategies().size());
	}
	...
	@Test
	public void testFactoryKeyCreation() throws Exception {
		final EntityDescriptor<CreationalEntity14> entity = this.model.getEntity(CreationalEntity14.class);
		Assert.assertEquals(1, entity.creationalStrategies().size());
		final CreationalStrategy<CreationalEntity14> constructorStrategy = entity.creationalStrategies().iterator().next();
		final CreationalEntity14 e = constructorStrategy.getInstance();
		Assert.assertEquals("instanceFactory", e.getConstructedBy());
	}
}
