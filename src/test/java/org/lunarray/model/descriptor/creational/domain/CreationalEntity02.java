 ...
 */
public class CreationalEntity02 {
	 ...
	 * Default constructor.
	 */
	private CreationalEntity02(final String constructedBy) {
		this.constructedBy = constructedBy;
	}

	public static CreationalEntity02 create() {
		return new CreationalEntity02("factoryMethod");
	}
