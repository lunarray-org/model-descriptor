 ...
 */
public class CreationalEntity04Impl
		implements CreationalEntity04 {
	 ...
	 * Default constructor.
	 */
	private CreationalEntity04Impl(final String constructedBy) {
		this.constructedBy = constructedBy;
	}

	public static CreationalEntity04Impl create() {
		return new CreationalEntity04Impl("factoryMethod");
	}
