 ...
 */
public class CompositePaginatedRegistryDictionaryTest {

	/** The dictionary. */
	private CompositePaginatedRegistryDictionary<String> dictionary;
	...
	public void init() throws Exception {
		...
		beans.add("test");
		EasyMock.expect(this.registry.lookupAll(PaginatedEntityDictionary.class)).andReturn(beans);
		EasyMock.expect(this.registry.lookup(PaginatedEntityDictionary.class, "test")).andReturn(this.entityDictionary);
		...
		this.dictionary = new CompositePaginatedRegistryDictionary<String>();
