...
@EntityQualifierPresentationHints({ @EntityQualifierPresentationHint(name = Qualifier01.class, hint = @EntityPresentationHint()),
		@EntityQualifierPresentationHint(name = Qualifier02.class, hint = @EntityPresentationHint(

		descriptionKey = "entity15", resourceBundle = "org.lunarray.test.Labels", visible = BooleanInherit.FALSE))

})
public class SampleEntity19 implements ModelMarker {
